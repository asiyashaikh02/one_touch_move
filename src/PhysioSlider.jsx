...
//   {
//     name: "Electrotherapy",
//     image: <img src={`${import.meta.env.BASE_URL}images/electrotherapy.jpg`} alt="Electrotherapy" />,
//     description:
//       "Using electrical energy to reduce pain, improve circulation, and enhance healing.",
//   },
//   {
//     name: "Hydrotherapy",
//     image: <img src={`${import.meta.env.BASE_URL}images/Hydrotherapy.jpg`} alt="Hydrotherapy" />,
//     description:
//       "Water-based treatments for rehabilitation, relaxation, and recovery.",
//   },
//   {
//     name: "Sports Physiotherapy",
//     image: <img src={`${import.meta.env.BASE_URL}images/sportstherapy.jpg`} alt="Sports Physiotherapy" />,
//     description:
...
// ✅ All images use BASE_URL (Vite project). 
// If you are using CRA, replace import.meta.env.BASE_URL with process.env.PUBLIC_URL
const physioTypes = [
  {
    name: "Manual Therapy",
    image: `${import.meta.env.BASE_URL}images/manual-therapy.jpg`,
    description:
      "Hands-on techniques to improve mobility, reduce pain, and restore function.",
  },
  {
    name: "Electrotherapy",
    image: `${import.meta.env.BASE_URL}images/electrotherapy.jpg`,
    description:
      "Using electrical energy to reduce pain, improve circulation, and enhance healing.",
  },
  {
    name: "Hydrotherapy",
    image: `${import.meta.env.BASE_URL}images/hydrotherapy.jpg`, // ✅ check file name case!
    description:
      "Water-based treatments for rehabilitation, relaxation, and recovery.",
  },
  {
    name: "Sports Physiotherapy",
    image: `${import.meta.env.BASE_URL}images/sportstherapy.jpg`,
    description:
      "Specialized therapy for sports-related injuries and performance improvement.",
  },
];
